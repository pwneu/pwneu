...
using Pwneu.Api.Features.Profile;
using Pwneu.Api.Options;

namespace Pwneu.IntegrationTests.Features.Profile;

[Collection(nameof(IntegrationTestCollection))]
public class ChangePasswordTests(IntegrationTestsWebAppFactory factory)
