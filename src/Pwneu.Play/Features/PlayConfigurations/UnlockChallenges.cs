...
public static class UnlockChallenges
{
        ...
        : IRequestHandler<Command, Result>
    {
        ...
        {
            await context.SetPlayConfigurationValueAsync(Consts.ChallengesLocked, false, cancellationToken);
    ...
    public class Endpoint : IEndpoint
    {
        ...
        {
            app.MapPut("configurations/challengesLocked/unlock", async (ISender sender) =>
                {
