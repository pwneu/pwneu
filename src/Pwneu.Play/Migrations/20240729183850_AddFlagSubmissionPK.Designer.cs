...
namespace Pwneu.Play.Migrations
{
    ...
    [Migration("20240729183850_AddFlagSubmissionPK")]
    partial class AddFlagSubmissionPK
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pwneu.Play.Shared.Entities.ChallengeFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pwneu.Play.Shared.Entities.FlagSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pwneu.Play.Shared.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Pwneu.Play.Shared.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pwneu.Play.Shared.Entities.FlagSubmission", b =>
                {
                    ...
                    b.HasOne("Pwneu.Play.Shared.Entities.User", "User")
                        .WithMany("FlagSubmissions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
