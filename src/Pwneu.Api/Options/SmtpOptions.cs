...
{
    [Required]
    public required bool NotifyLoginIsEnabled { get; init; }

    [Required]
    public required bool SendEmailConfirmationIsEnabled { get; init; }

    [Required]
    public required bool SendPasswordResetTokenIsEnabled { get; init; }
